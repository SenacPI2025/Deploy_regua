...
from regua2.views import agendamentos_barbeiro, suporte, suporte_barb, esqueci_senha, alterar_tema, alterar_tamanho_fonte, resetar_acessibilidade,  confirmar_agendamento, cancelar_agendamento_barbeiro, verificar_status_barbearia, salvar_horario_estimado, verificar_agendamento_ativo, cancelar_agendamento_barbeiro
urlpatterns = [
    path('admin/', admin.site.urls),
    path('', pag_principal, name='pag_inicial_atalho'),
    path('Home/', Home, name='Homeatalho'),
    path('suporte/', suporte, name='suporteatalho'),
    path('suporte_barb/', suporte_barb, name='suportebarbatalho'),
